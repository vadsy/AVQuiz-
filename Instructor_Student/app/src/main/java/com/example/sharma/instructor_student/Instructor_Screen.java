...
public class Instructor_Screen extends AppCompatActivity {

    Button picupload,google;
    ImageView mypic;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_instructor__screen);
        ...
        google=(Button)findViewById(R.id.gbutton);
